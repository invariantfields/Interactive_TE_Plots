...
# Complete & Exact Pauli SRE function in CuPy (accounting for I, X, Y, Z phases)
def compute_sre_native_cupy_exact(psi_batch_np: np.ndarray) -> np.ndarray:
    ...
    # Outer product for each state: conj(psi[s, x]) * psi[s, x ^ b]
...
if __name__ == "__main__":
    ...
    print("Computing Native CuPy GPU Exact SRE...")
    ...
    print("=================================================================")
    print(" EXACT PAULI Y-PHASE MATCHING (10 STATES)")
    print("=================================================================")
