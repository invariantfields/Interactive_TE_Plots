...
if __name__ == "__main__":
    ...
    # Parameters: 4 qubits, 500 seeds, 100 steps (chunk-size=1)
    stpsi = [100]
    qbt_nmbs = [4]
    num_seds = [500]
    ...
    for idx in range(len(qbt_nmbs)):
        ...
        print(f"\n=======================================================")
        print(f"Running simulation for {qbt_nmbs[idx]} Qubits | {num_seds[idx]} Seeds | {stpsi[idx]} Steps (Chunk size = 1)")
