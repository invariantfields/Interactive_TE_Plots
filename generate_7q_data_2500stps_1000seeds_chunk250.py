...
if __name__ == "__main__":
    os.makedirs("zip1", exist_ok=True)
    ...
    print("All simulation runs and SRE computations in zip1/ completed successfully!")
